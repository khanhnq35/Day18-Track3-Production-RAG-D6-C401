...
4. Dữ liệu cá nhân nhạy cảm là dữ liệu cá nhân gắn liên với quyền riêng tư của cá nhân mà khi bị xâm phạm sẽ gây ảnh hưởng trực tiếp tới quyền và lợi ích hợp pháp của cá nhân gồm:
...
d) Thông tin về đặc điểm di truyền được thu hưởng hoặc có được của cá nhân;
...
8. Sự đồng ý của chủ thể dữ liệu là việc thể hiện rõ ràng, tự nguyện, khả năng định vị cho phép xử lý dữ liệu cá nhân của chủ thể dữ liệu.
...
6. Dữ liệu cá nhân được áp dụng các biện pháp bảo vệ, bảo mật trong quá trình xử lý, bao gồm cả việc bảo vệ trước các hành vi vi phạm quy định về bảo vệ dữ liệu cá nhân và phòng, chống sự mất mát, hủy hoại hoặc thiệt hại do sự cố, sử dụng các biện pháp kỹ thuật.
...
5. Xây dựng, đào tạo, bồi dưỡng cán bộ, công chức, viên chức và người trực tiếp giao làm công tác bảo vệ dữ liệu cá nhân.
...
a) Chủ thể dữ liệu được phân đối Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân xử lý dữ liệu cá nhân của mình nhằm ngăn chặn hoặc hạn chế tiết lộ dữ liệu cá nhân hoặc sử dụng cho mục đích quảng cáo, tiếp thị, trừ trường hợp luật có quy định khác;
...
3. Sự đồng ý của chủ thể dữ liệu phải được thể hiện rõ ràng, cụ thể bằng văn bản, giong nói, đánh dấu vào ô đồng ý, cú pháp đồng ý qua tin nhắn, chọn các thiết lập kỹ thuật đồng ý hoặc một hành động khác thể hiện được điều này.  
...
2. Việc rút lại sự đồng ý phải được thể hiện ở một hình dạng có thể được in, sao chép bằng văn bản, bao gồm cả dưới dạng điện tử hoặc định dạng kiềm chứng được.
...
b) Việc cung cấp dữ liệu cá nhân của chủ thể dữ liệu có ảnh hưởng tới sự an toàn, sức khỏe thể chất tinh thần của người khác;
...
Khi nhận được yêu cầu cung cấp dữ liệu cá nhân hợp lệ, Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân có trách nhiệm cung cấp dữ liệu cá nhân thông báo về thời hạn, địa điểm, hình thức cung cấp dữ liệu cá nhân; chi phí thực tế để đề, in, sao, chụp, gửi thông tin qua dịch vụ bưu chính,
...
1. Chủ thể dữ liệu được yêu cầu Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân xóa dữ liệu cá nhân của mình trong các trường hợp sau:
   a) Nhận thấy không còn cần thiết cho mục đích thu thập dữ liệu và chấp nhận các thiệt hại có thể xảy ra khi yêu cầu xóa dữ liệu;
...
c) Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân, Bên thứ ba bị giải thể hoặc ngừng hoạt động hoặc tuyên bố phá sản hoặc bị chấm dứt hoạt động kinh doanh theo quy định của pháp luật.
...
3. Việc xử lý dữ liệu của cơ quan nhà nước có thẩm quyền trong trường hợp tình trạng khẩn cấp về quốc phòng, an ninh quốc gia, trật tự an toàn xã hội, thảm họa lớn, dịch bệnh nguy hiểm; khi có nguy cơ đe dọa an ninh, quốc phòng nhưng chưa đủ điều kiện ban bố tình trạng khẩn cấp; phòng, chống bao loan, khủng bố, chống tội phạm và vi phạm pháp luật theo quy định của luật.
...
sự đồng ý của cha, mẹ của người bị tuyên bố mất tích, người đã chết, trừ trường hợp quy định tại Điều 17 và Điều 18 Nghị định này.
...
1. Xử lý dữ liệu cá nhân của trẻ em luôn được thực hiện theo nguyên tắc bảo vệ các quyền và lợi ích tốt nhất của trẻ em.

2. Việc xử lý dữ liệu cá nhân của trẻ em phải có sự đồng ý của trẻ em trong trường hợp trẻ em từ đủ 7 tuổi trở lên và có sự đồng ý của cha, mẹ hoặc người giám hộ theo quy định, trừ trường hợp quy định tại Điều 17 Nghị định này. Bên Kiểm soát dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân trẻ em. Bên thứ ba phải xác minh tuổi của trẻ em trước khi xử lý dữ liệu cá nhân của trẻ em.

3. Ngừng xử lý dữ liệu cá nhân của trẻ em, xóa không thể khôi phục hoặc hủy dữ liệu cá nhân của trẻ em trong trường hợp:

a) Xử lý dữ liệu không đúng mục đích hoặc đã hoàn thành mục đích xử lý dữ liệu cá nhân được thể hiện bằng ý, trừ trường hợp pháp luật có quy định khác;
...
3. Nội dung thông báo vi phạm quy định về bảo vệ dữ liệu cá nhân:
   ...
   c) Mô tả tác hại, thiệt hại có thể xảy ra của việc vi phạm quy định bảo vệ dữ liệu cá nhân;

   d) Mô tả các biện pháp được đưa ra để giải quyết, giảm thiểu tác hại của hành vi vi phạm quy định bảo vệ dữ liệu cá nhân.

4. Trường hợp không thể thông báo đầy đủ các nội dung quy định tại khoản 3 Điều này, việc thông báo có thể được thực hiện theo từng giai đoạn.
...
c) Không bảo đảm quyền của chủ thể dữ liệu không được thực hiện đúng;
...
d) Tổ chức, cá nhân nhận dữ liệu cá nhân, bao gồm tổ chức, cá nhân ngoài lãnh thổ Việt Nam;
...
5. Bộ Công an (Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao) đánh giá, yêu cầu Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và hành xử dữ liệu cá nhân.
...
xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân hoàn thiện Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân trong trường hợp hồ sơ chưa đầy đủ và đúng quy định.
...
1. Dữ liệu cá nhân của công dân Việt Nam được chuyển ra nước ngoài trong trường hợp Bên chuyển dữ liệu ra nước ngoài lập Hồ sơ đánh giá tác động chuyển dữ liệu cá nhân ra nước ngoài và thực hiện các thủ tục theo quy định tại khoản 3, 4 và 5 Điều này. Bên chuyển dữ liệu ra nước ngoài bao gồm Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên thứ ba.
...
e) Mô tả và nếu có sự tuân thủ quy định bảo vệ dữ liệu cá nhân tại Nghị định này, chi tiết các biện pháp bảo vệ dữ liệu cá nhân được áp dụng;
...
Bên chuyển dữ liệu ra nước ngoài gửi 01 bản chính hồ sơ tới Bộ Công an (Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao) theo Mẫu số 06 tại Phụ lục của Nghị định này trong thời gian 60 ngày kể từ ngày tiến hành chuyển dữ liệu ra thành công.
...
2. Các biện pháp bảo vệ dữ liệu cá nhân, bao gồm:
   ...
   d) Biện pháp điều tra, tổ chức do cơ quan nhà nước có thẩm quyền thực hiện;
...
2. Xây dựng, ban hành các quy định về bảo vệ dữ liệu cá nhân, nếu rõ những việc cần thực hiện theo quy định của Nghị định này.
...
2. Chỉ định bộ phận có chức năng bảo vệ dữ liệu cá nhân, chỉ định nhân sự phụ trách bảo vệ dữ liệu cá nhân và trao đổi thông tin về bộ phận và cá nhân phụ trách bảo vệ dữ liệu cá nhân với cơ quan chuyên trách bảo vệ dữ liệu cá nhân. Trường hợp Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu, Bên thứ ba là cá nhân trao đổi thông tin cá nhân thực hiện.
...
# Điều 29. Cơ quan chuyển trách bảo vệ dữ liệu cá nhân và Công thông tin quốc gia về bảo vệ dữ liệu cá nhân

1. Cơ quan chuyển trách bảo vệ dữ liệu cá nhân là Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao - Bộ Công an, có trách nhiệm giúp Bộ Công an thực hiện quản lý nhà nước về bảo vệ dữ liệu cá nhân.

2. Công thông tin quốc gia về bảo vệ dữ liệu cá nhân:
   ...
   e) Cung cấp thông tin về kết quả đánh giá công tác bảo vệ dữ liệu cá nhân của cơ quan, tổ chức, cá nhân có liên quan;

   f) Tiếp nhận thông báo vi phạm quy định về bảo vệ dữ liệu cá nhân;
...
1. Lực lượng bảo vệ dữ liệu cá nhân:
   ...
   a) Lực lượng chuyển trách bảo vệ dữ liệu cá nhân được bố trí tại Cơ quan chuyển trách bảo vệ dữ liệu cá nhân;
...
3. Bảo đảm cơ sở vật chất, điều kiện hoạt động cho cơ quan chuyển trách bảo vệ dữ liệu cá nhân.
...
3. Kinh phí bảo vệ dữ liệu cá nhân của tổ chức, doanh nghiệp tự bố trí và thực hiện theo quy định.
...
3. Xây dựng, quản lý, vận hành Công thông tin quốc gia về bảo vệ dữ liệu cá nhân.
...
1. Thực hiện các biện pháp tổ chức và kỹ thuật cùng các biện pháp an toàn, bảo mật phù hợp để chứng minh các hoạt động xử lý dữ liệu cá nhân được thực hiện theo quy định của pháp luật về bảo vệ dữ liệu cá nhân, rà soát và cập nhật các biện pháp này khi cần thiết.
...
4. Lựa chọn Bên Xử lý dữ liệu cá nhân phù hợp với nhiệm vụ rõ ràng và chi làm việc với Bên Xử lý dữ liệu cá nhân có các biện pháp bảo vệ phù hợp.
...
1. Chi tiết nhận dữ liệu cá nhân sau khi có hợp đồng hoặc thỏa thuận về xử lý dữ liệu với Bên Kiểm soát dữ liệu cá nhân.
...
2. Các doanh nghiệp siêu nhỏ, doanh nghiệp nhỏ, doanh nghiệp vừa, doanh nghiệp khởi nghiệp được quyền lựa chọn miễn trừ quy định về quy định cá nhân và bảo vệ dữ liệu cá nhân trong thời gian 02 năm đầu kể từ khi thành lập doanh nghiệp.
...
2. Bộ trưởng, Thủ trưởng cơ quan ngang bộ, Thủ trưởng cơ quan thuộc Chính phủ, Chủ tịch Ủy ban nhân dân các tỉnh, thành phố thuộc trung ương chịu trách nhiệm thi hành Nghị định này.
...
3. Số CMND/Thẻ căn cước công dân/Hộ chiếu: ...........................................
...
4 Ghi rõ chi tiết để dữ liệu và các thông tin liên quan cần cung cấp.  
...
## THÔNG BÁO  
**VỀ VI PHẠM QUY ĐỊNH BẢO VỆ DỮ LIỆU CÁ NHÂN**
